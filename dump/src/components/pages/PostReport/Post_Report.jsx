...
function PostRegister(props) {
  ...
  return (
    <form
      className="postRegisterForm"
      method="POST"
      action="/post_reports/post"
      ...
      <div className="postRegisterForm_content">
        ...
        <div className="postRegisterForm_content_type">
          ...
          <div className="postRegisterForm_content_type_insalubrite">
            ...
            <input
              type="radio"
              id="reportInsalubrite"
              value="reportInsalubrite"
              name="report"
              onChange={handleChange}
              required
            />
        ...
        <div className="postRegisterForm_content_adress">
          ...
          <input
            type="text"
            id="numberStreetRegister"
            name="numberStreet"
            placeholder="1"
            value={post.numberStreet}
            onChange={handleChange}
            required
          />
        ...
        <div className="postRegisterForm_content_submit">
          <button
            className="postRegisterForm_content_submit_button"
            type="submit"
          >
            Valider
          </button>
